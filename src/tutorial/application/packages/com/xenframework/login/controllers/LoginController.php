...
namespace com\xenframework\login\controllers;
...
class LoginController extends Controller
{
    ...
    {
        $user = $this->_model->login($this->_request->post());
        ...
        if ($user != null) {
            ...
            $this->_redirect($this->_router->toUrl('com_xenframework_login_controllers_login_index'));
